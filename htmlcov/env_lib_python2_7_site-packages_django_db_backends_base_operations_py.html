...
<head>
    ...
    <title>Coverage for env/lib/python2.7/site-packages/django/db/backends/base/operations.py: 43%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>env/lib/python2.7/site-packages/django/db/backends/base/operations.py</b> :
...
<p id="t484" class="stm mis">        <span class="key">return</span> <span class="nam">value</span> <span class="key">or</span> <span class="nam">None</span><span class="strut">&nbsp;</span></p>
