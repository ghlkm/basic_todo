...
<head>
    ...
    <title>Coverage for env/lib/python2.7/site-packages/django/template/defaultfilters.py: 28%</title>
...
<p id="t844" class="pln">    <span class="str">"""Returns True if the value is divisible by the argument."""</span><span class="strut">&nbsp;</span></p>
